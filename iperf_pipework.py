...
client_options="-c "+ServerIP+" -P 1 -i 1 -p 5001 -f m -t 15"
...
# Procedure for running commands 
...
fclntstp.write("ip a show\n")
# check IP settings

fclntstp.write("iperf \"$@\"\n")
# $@ - commandline parameters from "docker run ..." command
# console output record inside of stopped contaier can be viewed using "docker logs" command
fclntstp.close()
